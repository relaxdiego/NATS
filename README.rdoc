...
Behold, the Neo-Analytic Time Sequencer!!!1111
...
OK OK, it's just a simple timer my friends and I built from scratch. Why? Because we're geeks. We also use it keep the speakers for http://www.ideacampdavao.com on their toes. We don't like listening to long talks, you see. :-)
...
5. If the above didn't open in Firefox, repeat step 4!!!! We don't like IE.
6. Revel in the wonder that is N.A.T.S!!!

= Credits

* Nathaniel 'Nats' B. Jayme (the guy who started it all)
* Mark 'Relaxdiego' Maglana (the guy who's been OC-ing on this script since then)
* George 'Mad Guitar Skillz' Tujan (who????)

= Compatibility

This script has only been tested in Firefox 3.5.x.
